...
all_names = {0x8 : "Hookshot", 0x9 : "Candle  ", 0xA : "Gray Key",0xB : "Gold Key", 0xC :"Shovel", 0xD : "Bell", 0xE : "Bridge", 0x40 : "Cherry", 0x42: "Banana", 0x44 : "Red Gem", 0x46 : "Blue Gem"}
...
class Items:
    ...
    def __call__(self, randomize_items=False, randomize_fruits=False, combine=False):
        ...
        if combine: warn(f"Currently, combining pools doesn't work. The randomization works, but the game doesn't.")
    ...
    def nodes(self, sorties):
        ...
        items_data = {7:("7 (W)",),  # W0 : plank 
                        9:("9 (S)",),  # W0 : Shovel
                        10:("OOB", "OOB"),  # W0 : Wooden platform screen, with banana and blue gem oob.
                        23:("7 (C)", "7 (C)", "OOB"),  # W1 : Hookshot + plank
